...
const GALLERY_ITEMS = [
  ...
  { id: 2,  src: "cindy-hair-salon-pic/Image_20260410170637_3_2.jpg",  thumb: "cindy-hair-salon-pic/Image_20260410170637_3_2.jpg",  alt: "Haircut style",  caption: "Layered Cut",            category: "cut" },
  ...
  { id: 4,  src: "cindy-hair-salon-pic/Image_20260410184452_5_2.jpg",  thumb: "cindy-hair-salon-pic/Image_20260410184452_5_2.jpg",  alt: "Hair color",     caption: "Vibrant Color",          category: "color" },
  ...
  { id: 9,  src: "cindy-hair-salon-pic/Image_20260410184517_11_2.jpg", thumb: "cindy-hair-salon-pic/Image_20260410184517_11_2.jpg", alt: "Hair styling",   caption: "Voluminous Blowout",     category: "styling" },
  ...
  { id: 11, src: "cindy-hair-salon-pic/Image_20260410184526_13_2.jpg", thumb: "cindy-hair-salon-pic/Image_20260410184526_13_2.jpg", alt: "Highlights",     caption: "Balayage Highlights",    category: "highlights" },
...
let visibleItems  = []; // indices into GALLERY_ITEMS that pass the current filter
let lightboxIndex = 0;

/* ── Build all gallery item DOM nodes once ──────────────── */
...
function renderPage() {
  const allEls = document.querySelectorAll(".gallery-item");
  allEls.forEach(el => { el.style.display = "none"; });
  visibleItems.forEach(idx => { allEls[idx].style.display = ""; });
}
...
function showLightboxItem() {
  const item = GALLERY_ITEMS[visibleItems[lightboxIndex]];
  if (!item) return;
